...
const translations = {
  pt: {
    ...
    "education-title": "Cursos e Certificações",
    "skills-title": "Habilidades",
    "contact-title": "Contato",
    "brand-subtitle": "Desenvolvedor Back-end",
    "hero-title": "Olá — eu sou o Vitor.",
    "hero-subtitle": "Olá — eu sou o Vitor",
    "hero-desc": "Sou formado em Análise e Desenvolvimento de Sistemas (Fundação Santo André, 2025) e atualmente curso Engenharia de Software na Universidade Anhanguera. Trabalho com desenvolvimento back-end — APIs, integrações e bancos de dados — unindo lógica, curiosidade e entrega rápida. Gosto de criar soluções acessíveis, medir resultados e iterar com base em feedback. Procuro oportunidades para construir sistemas robustos com impacto real, colaborando em equipes multidisciplinares.",
    ...
    "about-desc": "No dia a dia aplico IA, web e dados para resolver problemas de negócio. Curto traduzir requisitos em protótipos rápidos, medir impacto e iterar. Valorizo código limpo, documentação objetiva e colaboração com design e produto.",
    "view-certificate": "Ver certificado",
    "academic-title": "Trajetória Acadêmica",
    "academic-lead": "Resumo rápido da minha formação atual.",
    "academic-ads": "<strong>Fundação Santo André</strong> — Análise e Desenvolvimento de Sistemas (concluído em 2025)",
    "academic-software": "<strong>Universidade Anhanguera</strong> — Engenharia de Software (cursando, início em 2026)",
  ...
  en: {
    ...
    "brand-subtitle": "Back-end Developer",
    "hero-title": "Hi — I'm Vitor.",
    "hero-subtitle": "Hi — I'm Vitor",
    "hero-desc": "I graduated in Systems Analysis and Development (Fundação Santo André, 2025) and I am currently pursuing Software Engineering at Universidade Anhanguera. I work in back-end development — APIs, integrations, and databases — combining logic, curiosity, and fast delivery. I like to build accessible solutions, measure outcomes, and iterate based on feedback. I look for opportunities to build robust systems with real impact, collaborating in multidisciplinary teams.",
    ...
    "about-desc": "Day to day I apply AI, web, and data to solve business problems. I enjoy turning requirements into quick prototypes, measuring impact, and iterating. I value clean code, concise docs, and close collaboration with design and product.",
    "view-certificate": "View certificate",
    "academic-title": "Academic Path",
    "academic-lead": "Quick snapshot of my current studies.",
    "academic-ads": "<strong>Fundação Santo André</strong> — Systems Analysis and Development (completed in 2025)",
    "academic-software": "<strong>Universidade Anhanguera</strong> — Bachelor in Software Engineering (in progress, started in 2026)",
  ...
  es: {
    ...
    "brand-subtitle": "Desarrollador Back-end",
    "hero-title": "Hola — soy Vitor.",
    "hero-subtitle": "Hola — soy Vitor",
    "hero-desc": "Soy graduado en Análisis y Desarrollo de Sistemas (Fundação Santo André, 2025) y actualmente curso Ingeniería de Software en la Universidade Anhanguera. Trabajo en desarrollo back-end — APIs, integraciones y bases de datos — uniendo lógica, curiosidad y entrega rápida. Me gusta crear soluciones accesibles, medir resultados e iterar con base en feedback. Busco oportunidades para construir sistemas robustos con impacto real, colaborando en equipos multidisciplinarios.",
    ...
    "about-desc": "En el día a día aplico IA, web y datos para resolver problemas de negocio. Me gusta traducir requisitos en prototipos rápidos, medir impacto e iterar. Valoro código limpio, documentación concisa y la colaboración con diseño y producto.",
    "view-certificate": "Ver certificado",
    "academic-title": "Trayectoria Académica",
    "academic-lead": "Resumen rápido de mis estudios actuales.",
    "academic-ads": "<strong>Fundação Santo André</strong> — Análisis y Desarrollo de Sistemas (concluido en 2025)",
    "academic-software": "<strong>Universidade Anhanguera</strong> — Ingeniería de Software (en curso, inicio en 2026)",
