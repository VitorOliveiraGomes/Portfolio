...
const translations = {
  pt: {
    ...
    "hero-desc": "Sou formado em Análise e Desenvolvimento de Sistemas (Fundação Santo André, 2025) e atualmente curso Engenharia de Software na Universidade Anhanguera. Trabalho com IA, desenvolvimento web e análise de dados, unindo lógica, curiosidade e entrega rápida. Gosto de criar soluções acessíveis, medir resultados e iterar com base em feedback. Procuro oportunidades para construir produtos com impacto real, colaborando em equipes multidisciplinares.",
  ...
  es: {
    ...
    "hero-desc": "Soy graduado en Análisis y Desarrollo de Sistemas (Fundação Santo André, 2025) y actualmente curso Ingeniería de Software en la Universidade Anhanguera. Trabajo con IA, desarrollo web y análisis de datos, uniendo lógica, curiosidad y entrega rápida. Me gusta crear soluciones accesibles, medir resultados e iterar con base en feedback. Busco oportunidades para construir productos con impacto real, colaborando en equipos multidisciplinarios.",
